# HTML with Zoom Level

This example demonstrates how to convert html including zoom level using GroupDocs.Conversion.LowCode.
...
### Output Files
- `zoomed-sample.pdf` - Converted output document
