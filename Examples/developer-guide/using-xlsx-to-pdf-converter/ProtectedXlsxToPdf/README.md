# Protected XLSX to PDF

This example demonstrates how to convert protected xlsx to PDF using GroupDocs.Conversion.LowCode.
...
### Input Files
- `protected.xlsx` - Source document for conversion
