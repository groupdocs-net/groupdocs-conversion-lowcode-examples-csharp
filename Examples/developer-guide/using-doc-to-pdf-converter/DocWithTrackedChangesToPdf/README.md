# DOC with Tracked Changes to PDF

This example demonstrates how to convert doc with tracked changes to PDF using GroupDocs.Conversion.LowCode.
...
### Input Files
- `tracked-changes.doc` - Source document for conversion
